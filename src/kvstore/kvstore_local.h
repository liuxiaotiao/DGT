...
class KVStoreLocal : public KVStore {
 public:
  ...
  void Push(const std::vector<int>& keys,
    ...
    SetKeyType(kIntKey);
//    std::cout<<"node-1 Push PushImpl"<<std::endl;
  ...
  void Pull(const std::vector<int>& keys,
    ...
    SetKeyType(kIntKey);
//    std::cout<<"node-1 kvstore_local Pull"<<std::endl;
  ...
  void Broadcast(const std::vector<int>& vkeys,
                 ...
                 int priority) override {
    SetKeyType(kIntKey);
//    std::cout<<"node-1 kvstore_local Broadcast(int)"<<std::endl;
...
//    std::cout<<"node-1 Push(string) PushImpl"<<std::endl;
    PushImpl(keys, values, priority);
  }
...
//    std::cout<<"node kvstore_local Broadcast"<<std::endl;
 ...
 private:
  virtual void InitImpl(const std::vector<int>& keys,
                        const std::vector<NDArray>& values) {
//	  std::cout<<"node-1 local initimpl"<<std::endl;
...
//    std::cout<<"node-1 kvstore_local BroadcastImpl"<<std::endl;
  ...
  virtual void PushPullImpl(const std::vector<int>& vkeys,
                            ...
                            const std::vector<NDArray*>& outs,
                            int priority) {
//    std::cout<<"node-1 kvstore_dist PushPullImpl"<<std::endl;
